...
このため、Discord から来た人にはまず API キーなしの fallback viewer レビューを案内します。README 再現性や課金境界の追加 feedback は、新しい小さい issue に分けます。GCS、Cloud Run、Vertex AI、Google Maps、Google Places は maintainer が範囲を切ってから扱います。
...
| #16 | Discord から来た人向けの案内は、milestone と初回 issue を中心に整理済みです。現在 open の入口は #11 です。 |
