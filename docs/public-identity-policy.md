...
- public PR を作る行為は TYPE1 として扱い、人間レビュー後にだけ公開する。
...
public PR の公開前 gate は [`docs/type1-public-pr-gate.md`](type1-public-pr-gate.md) に従います。
...
- 人間レビューなしで public PR を作る、public branch を push する、PR を ready / merge する。
