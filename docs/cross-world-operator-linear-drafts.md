...
現在の `0.1.9` は、MVP-007 Repo-as-Skill And Distributed Opsの実装前仕様とdrift gate拡張を追加したPATCH更新です。Urban Ecosystem data contract はこのPRでは変更しません。
...
- MVP-007以降:
  - repo-as-skill mesh、recursive skill calls、distributed opsはこの前提に従って設計する。
