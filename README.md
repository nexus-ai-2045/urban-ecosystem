...
このため、リポジトリ参加の正規ルートは fallback viewer です。Cloud Run の URL、Nexus 管理 project、Map ID、実 Google Maps 表示は、参加の前提ではなく maintainer demo / advanced setup として扱います。
