...
public PR を作る行為自体は TYPE1 です。PR を公開する前に、人間レビューを必ず通してください。詳細は [`docs/type1-public-pr-gate.md`](docs/type1-public-pr-gate.md) を見てください。
...
- public repository に PR を作る、PR 用 branch を push する、PR を ready / merge する
